  ...
  return (
    <header className="sticky top-0 bg-white shadow z-50">
      <div className="max-w-7xl mx-auto flex justify-between items-center px-6 py-4">
        <Link href="/">
          <Image src="/vegan.png" alt="Logo" width={50} height={50} />
        </Link>
        <nav className="flex items-center space-x-6">
          ...
          <Link href="/get-started">
            <button className="bg-blue-900 text-white px-4 py-2 rounded transition duration-300 ease-in-out hover:text-white-600 hover:bg-yellow-600">
              Get Started
            </button>
          </Link>
        </nav>
